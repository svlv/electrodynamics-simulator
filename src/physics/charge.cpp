...
charge::charge(const point& coord, double value) : _coord(coord), _value(value), _lines(get_lines_count(), 0U)
{
}
...
size_t charge::get_lines_count() const
{
  return abs(_value) * 8U;
}
