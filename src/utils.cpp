...
void draw_arrow(const Cairo::RefPtr<Cairo::Context> &cr, point coord,
                float sin_, float cos_, const ArrowSize &size) {
  std::vector<point> points = {{-1.0 * size.a / 2, (size.b + size.d) / 2.0},
                               {size.a, 0.0},
                               {0.0, -1.0 * size.b},
                               {size.c, 0.0},
